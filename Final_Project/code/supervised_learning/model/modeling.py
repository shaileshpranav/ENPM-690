...
class Transformer(nn.Module):
    def __init__(self, config, img_size, vis, in_channels=5):
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=36, in_channels=5, zero_head=False, vis=False):
...
CONFIGS = {
    'ViT-toy': configs.get_toy_config(),
    'ViT-big-toy': configs.get_big_toy_config(),
